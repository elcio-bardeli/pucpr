...
#ADDED
imgs_list_path = "driver_imgs_list.csv"
...
#INCLUI BASE MODEL EM TUDO
    ...
    #base_model.fit(X_train, Y_train, batch_size=batch_size, epochs=nb_epoch, verbose=1, validation_data=(X_valid, Y_valid))
    ...
    #score_test = model.evaluate(test_data, test_id, verbose=1)
    # score = model.evaluate(X_valid, Y_valid, verbose=1)
   # print('Score Test log_loss: ', score_test[0])
    #print('Valid accuracy: ', score_test[1])

    predictions_valid = model.predict(X_valid, batch_size=2, verbose=1)
    #predictions_valid = model.predict(X_valid, batch_size=2, verbose=1)
